...
🎯 Features
Secure login with role-based access (HR Admin, Employee)
Leave request system
Attendance tracking
Automated payroll calculations with tax
Generate PDF reports (payroll)
Password reset and recovery system
Scalable user dashboard for both desktop and mobile
Data security compliant with POPIA and other regulations
Responsive and user-friendly interface
Perfomance review, where the employee can see their reviews and the manager's comment
